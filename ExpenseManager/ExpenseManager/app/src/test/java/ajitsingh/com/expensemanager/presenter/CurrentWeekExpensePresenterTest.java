...
public class CurrentWeekExpensePresenterTest {
  ...
  public void setUp() throws Exception {
    ...
    Expense expense1 = new Expense(90., "Food", "03-09-2015");
    Expense expense2 = new Expense(100., "Travel", "31-08-2015");
  ...
  public void shouldRenderExpensesOfCurrentWeek() throws Exception {
    ...
    assertThat(expenseGroupByDate.get("31-08-2015").get(0).getAmount(), is(100.));
    ...
    assertThat(expenseGroupByDate.get("03-09-2015").get(0).getAmount(), is(90.));
  ...
  public void shouldRenderTotalExpensesOfCurrentWeek() throws Exception {
    ...
    verify(view).displayTotalExpenses(190.);
  }
}