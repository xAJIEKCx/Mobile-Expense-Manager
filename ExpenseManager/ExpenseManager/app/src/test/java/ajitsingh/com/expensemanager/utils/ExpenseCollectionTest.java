...
public class ExpenseCollectionTest {
  ...
  public void setUp() throws Exception {
    food = new Expense(100., "Food", "31-09-2015");
    travel = new Expense(150., "Travel", "02-10-2015");
    Expense movie = new Expense(100., "Movie", "02-10-2015");
    expenseCollection = new ExpenseCollection(asList(food, movie, travel));
  }

  @Test
  public void shouldReturnTotalExpense() throws Exception {
    assertThat(expenseCollection.getTotalExpense(), is(350.));
  }
